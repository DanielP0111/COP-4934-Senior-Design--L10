...
## DocTalk Version 2 (V2)
Our main branch hosts all of the code and documentation for DocTalk V2. V2 is a defense variation that balances security and usability by implementing technical and prompt-based guardrails to prevent DocTalk from being breached. Feel free to try your own attacks and defenses against DocTalk V2!
